...
// 启用Docking（窗口停靠、拆分面板，强烈建议开启）
#define IMGUI_ENABLE_DOCKING
// 启用多视口（窗口可以拖出主窗口，独立系统窗口）
#define IMGUI_ENABLE_VIEWPORTS

// 禁用内置默认字体（后续自己加载中文字体，可选开启）
//#define IMGUI_NO_DEFAULT_FONT

// 支持wchar，中文相关辅助
#define IMGUI_USE_WCHAR32

// ====================== 内存、调试 ======================
// 关闭调试日志，发布程序可以保留；开发阶段打开
//#define IMGUI_USE_DEBUG_ALLOCATOR

// 禁用平台窗口自动保存ini布局（如果你不需要记忆窗口位置大小）
//#define IMGUI_DISABLE_WIN32_FUNCTIONS
//#define IMGUI_DISABLE_FILE_FUNCTIONS

// ====================== 输入与交互 ======================
// 启用键盘导航（方向键Tab切换控件）
#define IMGUI_ENABLE_NAVIGATION
// 启用游戏手柄导航（不需要可以注释掉）
//#define IMGUI_ENABLE_NAVIGATION_GAMEPAD

// ====================== 渲染相关 ======================
// 禁用Anti-aliasing 抗锯齿（不建议关闭）
//#define IMGUI_DISABLE_ANTIALIASING

// ====================== 按需关闭不需要模块，减小体积 ======================
// 如果不用表格控件，可以开启，减小编译体积
//#define IMGUI_DISABLE_TABLES
// 如果不用树形、折叠面板
//#define IMGUI_DISABLE_TREE
// 不用绘图API（画线、圆等）
//#define IMGUI_DISABLE_DRAW_FUNCTIONS

// ====================== Windows / SDL3 适配提示 ======================
// 如果你切换为纯Win32后端不需要修改；SDL3后端同样兼容
// #define IMGUI_IMPL_API 动态库导出，你静态编译exe不用管
